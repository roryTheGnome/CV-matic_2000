      ...
      <nav className="bg-background hidden h-full flex-col justify-between p-4 pl-0 md:flex">
        ...
        <div className="relative flex items-center gap-3 px-2">
          <button
            ...
            className="hover:bg-surface-active flex items-center gap-3 rounded px-2 transition"
          >
            {user?.profile?.avatar ? (
              <img
          ...
          {open && (
            <div className="bg-surface border-input-border absolute bottom-full left-0 z-50 mb-2 w-56 rounded border shadow-lg">
              <div className="flex flex-col py-2">
                ...
                <div className="border-input-border my-2 border-t" />
                <LogoutButton />
              </div>
            </div>
          )}
